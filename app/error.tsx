  ...
  return (
    <div className="min-h-screen bg-[#0F2D5A] flex items-center justify-center px-4">
      <div className="text-center">
        ...
        <button
          onClick={() => reset()}
          className="inline-block px-8 py-4 bg-[#2D69B4] text-white font-semibold rounded hover:bg-[#96C3E1] hover:text-[#0F2D5A] active:opacity-80 transition-all duration-300 cursor-pointer"
        >
          Try Again
        </button>
      </div>
